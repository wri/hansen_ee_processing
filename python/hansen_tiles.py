...
HANSEN_COMPOSITE_IMG = 'HansenComposite_19'
HANSEN_ZLEVEL_FOLDER = 'HansenZLevel_19'
GCE_TILE_ROOT = 'v1.7'
...
def export_tiles(image, z, v, threshold):
    tiles_path = gce_tiles_path(threshold)
...
# PATH/IMG/IC HELPERS
#
def gce_tiles_path(threshold):
    return f"{GCE_TILE_ROOT}/tcd_{threshold}"
...
def zlevel_asset_name(v, z, threshold):
    ...
    return re.sub('\.', '-', 'hansen_{}_v{}_z{}_tc{}'.format("world", v, z, threshold))
